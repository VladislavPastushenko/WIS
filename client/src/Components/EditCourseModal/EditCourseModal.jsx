...
const EditCourseModal = ({isModalOpen, setModalOpen, course, sideEffectOnChange}) => {
    ...
    const [selectedTeachers, setSelectedTeachers] = useState(course.lectors || [])
    ...
    const addTeacher = (idx) => {
        setSelectedTeachers(prev => [...prev, {...teachers[0]}])
    }
                    ...
                    <Form.Group className="mb-3">
                        ...
                        {isLoadingTeachers ?
                            ...
                            {selectedTeachers && selectedTeachers.map((selectedTeacher, idx) => {
                                return (
                                    <>
                                    <Form.Select defaultValue={selectedTeacher.id_person} onChange={(e) => {selectTeacher(idx, e.currentTarget.value)}}>
                                        {teachers.map(el =>
